  ...
  return (
    <Card className="[&_.ant-card-body]:p-0">
      <div className="border-b border-border-secondary px-24 py-16">
        <div className="grid grid-cols-[minmax(320px,1fr)_160px_180px_128px] items-center gap-16 text-sm text-text-secondary">
          <span>计划名称</span>
          <span>状态</span>
          <span>完成进度</span>
      ...
      <div className="divide-y divide-border-secondary">
        {items.map((plan) => {
          ...
          return (
            <div key={plan.id} className="grid grid-cols-[minmax(320px,1fr)_160px_180px_128px] items-center gap-16 px-24 py-20">

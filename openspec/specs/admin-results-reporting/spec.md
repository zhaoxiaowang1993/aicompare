...
Define admin plan statistics, comparison decision/reason distributions, manual completion reporting, annotation detail filtering, local timezone semantics, and statistics-detail consistency.
